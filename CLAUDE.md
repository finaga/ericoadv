...
| `Web/index.html` | Project hub. **Five cards** (renumbered Jun 2026): 01 Estratégia · 02 Manual · 03 O Site (`site.html`) · 04 O Site — Versão B (`v2.html`, dark accent) · 05 Downloads. |
